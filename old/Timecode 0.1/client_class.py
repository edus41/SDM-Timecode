...
class Client():
    def __init__(self,host="192.168.0.9",port=12345):
        self.host = host
        self.port = port
        ...
        while not self.connected:
            ...
            try:
                ...
                while self.connected:
                    ...
                    receiver_thread: Thread = Thread(target = self._receiver, args=(self.client,))
                ...
                #if e.errno == 10061:
                log(f"[ERROR]: Ningun Servidor Disponible En: {self.direccion}, Reintentando...", MAGENTA)
                #else:
    ...
    def _receiver(self, conexion):
        while self.connected:
            ...
            try:
                ...
                log(self.ultimo_mensaje, YELLOW)
